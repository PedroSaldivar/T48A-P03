...
Original file is located at
    https://colab.research.google.com/drive/1YcQmCyqSC9QrRJ_1UGVw41rdb_vJWjFY
"""
...
#Media
meanA=np.mean(altura)
meanC=np.mean(cintura)
print(f"MEDIA")
print(f"Media altura: {meanA}")
print(f"Media cintura: {meanC}")
print(f" ")

#Mediana
print(f"MEDIANA")
medianA=np.median(altura)
medianC=np.median(cintura)
print(f"Mediana altura: {medianA}")
print(f"Mediana cintura: {medianC}")
print(f" ")
...
stdA=np.std(altura)
stdC=np.std(cintura)
print(f"Desviación estándar altura: {stdA}")
print(f"Desviación estándar cintura: {stdC}")
print(f" ")
...
varA=np.var(altura)
varC=np.var(cintura)
print(f"Varianza altura: {varA}")
print(f"Varianza cintura: {varC}")
print(f" ")
...
maxC=np.max(cintura)
minC=np.min(cintura)
print(f"Máximo altura: {maxA}, Mínimo altura: {minA}")
print(f"Máximo cintura: {maxC}, Mínimo cintura: {minC}")
print(f" ")

#Percentiles
print(f"PERCENTILES")
percentile25A=np.percentile(altura,25)
percentile75A=np.percentile(altura,75)
percentile25C=np.percentile(cintura,25)
percentile75C=np.percentile(cintura,75)
print(f"Percentil 25 altura: {percentile25A}, Percentil 75 altura: {percentile75A}")
print(f"Percentil 25 cintura: {percentile25C}, Percentil 75 cintura: {percentile75C}")
print(f" ")

#Histograma
import matplotlib.pyplot as plt
plt.hist(altura, bins=10)
plt.xlabel("Altura")
plt.ylabel("Frecuencia")
plt.title("Histograma de la altura")
plt.show()

plt.hist(cintura, bins=10)
plt.xlabel("Cintura")
plt.ylabel("Frecuencia")
